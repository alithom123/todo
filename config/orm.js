...
var orm = {
    ...
    selectAll: function selectAll(table, callback) {
        console.log("Running selectAll");
    ...
    insertOne: function insertOne(table, cols, vals, callback) {
        console.log("Running insertOne");
